...
export const produceCatalogue = [
  { id:'LST-012', farmer:'Danjuma Pwajok', lga:'Bokkos',      produce:'Irish potato',  price:38500, unit:'50kg bag',  qty:'80 bags',    harvestDate:'28 Jun 2026', verified:true,  category:'Tubers',     rating:4.8, reviews:34, description:'Grade A highland potatoes, no pesticides. Perfect for bulk buyers and market resale.', imageUrl:'/raw-dirty-potatoes-supermarket-closeup.jpg' },
  { id:'LST-010', farmer:'Blessing Dung',  lga:'Barkin Ladi', produce:'Cabbage',        price:9500,  unit:'net',       qty:'100 nets',   harvestDate:'30 Jun 2026', verified:true,  category:'Vegetables', rating:4.6, reviews:22, description:'Large firm heads, harvested fresh from Barkin Ladi highlands.', imageUrl:'/closeup-shot-cabbages-each-other-lights-market.jpg' },
  { id:'LST-009', farmer:'Yakubu Garkuwa', lga:'Riyom',       produce:'Carrot',         price:27000, unit:'50kg bag',  qty:'30 bags',    harvestDate:'02 Jul 2026', verified:true,  category:'Vegetables', rating:4.5, reviews:17, description:'Sweet Riyom carrots, well-sized and clean. Good shelf life.', imageUrl:'/premium-fresh-organic-carrots.jpg' },
  { id:'LST-008', farmer:'Grace Mwanret',  lga:'Pankshin',    produce:'Fonio',           price:64000, unit:'100kg bag', qty:'10 bags',    harvestDate:'10 Jul 2026', verified:false, category:'Grains',     rating:4.3, reviews:9,  description:'Organic fonio, hand-processed. Great for health food buyers.', imageUrl:'/sesame-seeds-dark-background.jpg' },
  { id:'LST-007', farmer:'Ruth Gyang',     lga:'Jos South',   produce:'Sweet pepper',   price:35000, unit:'basket',    qty:'25 baskets', harvestDate:'01 Jul 2026', verified:true,  category:'Vegetables', rating:4.7, reviews:28, description:'Tatashe variety, mild heat, excellent shelf life and colour.', imageUrl:'/color-bell-peppers-rustic-tray-with-water-drops-them.jpg' },
  { id:'LST-006', farmer:'Yusuf Danboyi',  lga:'Shendam',     produce:'Groundnut',       price:72000, unit:'100kg bag', qty:'20 bags',    harvestDate:'15 Jul 2026', verified:true,  category:'Legumes',    rating:4.9, reviews:41, description:'Shelled and sun-dried groundnuts. Ideal for processing or resale.', imageUrl:'/groundnuts-heart-shape-plate-put-sack-groundnuts.jpg' },
  { id:'LST-005', farmer:'Daniel Choji',   lga:'Mangu',       produce:'Tomato',          price:22000, unit:'basket',    qty:'40 baskets', harvestDate:'29 Jun 2026', verified:true,  category:'Vegetables', rating:4.4, reviews:19, description:'Roma tomatoes, firm. Good for long-distance transport and market.', imageUrl:'/top-view-ripe-fresh-tomatoes-with-water-drops-black-background.jpg' },
  { id:'LST-004', farmer:'Esther Pam',     lga:'Bokkos',      produce:'Onion',           price:58000, unit:'100kg bag', qty:'15 bags',    harvestDate:'05 Jul 2026', verified:false, category:'Vegetables', rating:4.2, reviews:11, description:'Dry season onions with long shelf life. Well dried and bagged.', imageUrl:'/shallot-background.jpg' },
  { id:'LST-003', farmer:'Ibrahim Jang',   lga:'Wase',        produce:'Soybean',         price:88000, unit:'100kg bag', qty:'8 bags',     harvestDate:'20 Jul 2026', verified:true,  category:'Legumes',    rating:4.6, reviews:14, description:'High-protein soybeans, sun-dried and machine-cleaned.', imageUrl:'/soybean-sauce-soybean-wooden-floor-soy-sauce-food-nutrition-concept.jpg' },
]
